...
emp_dict = [
    ...
    {'empno':210, 'name':'쌍용', 'job':'IT_PROG'},
    {'empno':445, 'name':'마이클', 'job':'IT_PROG'},
    {'empno':210, 'name':'어두일미', 'job':'Analysis'}
]
df = DataFrame(emp_dict)
print(df)
print("=========================중복 확인===========================")
print(df.duplicated("empno"))
print("=========================중복 data 마지막 살리고 삭제===========================")
print(df.drop_duplicates("empno", keep="last"))

print("=========================중복 data 전부 삭제===========================")
print(df.drop_duplicates("empno", keep=False))